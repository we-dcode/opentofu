...
import (
	...
	backendRemote "github.com/we-dcode/opentofu/pkg/backend/remote"
	backendAzure "github.com/we-dcode/opentofu/pkg/backend/remote-state/azure"
	backendConsul "github.com/we-dcode/opentofu/pkg/backend/remote-state/consul"
	backendCos "github.com/we-dcode/opentofu/pkg/backend/remote-state/cos"
	backendGCS "github.com/we-dcode/opentofu/pkg/backend/remote-state/gcs"
	backendHTTP "github.com/we-dcode/opentofu/pkg/backend/remote-state/http"
	backendInmem "github.com/we-dcode/opentofu/pkg/backend/remote-state/inmem"
	backendKubernetes "github.com/we-dcode/opentofu/pkg/backend/remote-state/kubernetes"
	backendOSS "github.com/we-dcode/opentofu/pkg/backend/remote-state/oss"
	backendPg "github.com/we-dcode/opentofu/pkg/backend/remote-state/pg"
	backendS3 "github.com/we-dcode/opentofu/pkg/backend/remote-state/s3"
	backendCloud "github.com/we-dcode/opentofu/pkg/cloud"
)
